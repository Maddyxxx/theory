   ...
   горутиы нужны для реализации параллелизма и асинхронщины + для уменьшения расходов для переключения контекста (для горутин это будет проще чем у потоков системных)
